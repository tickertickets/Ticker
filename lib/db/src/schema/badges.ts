...
// NOTE: "tag_friend" and "party_accept" are legacy enum values kept only
// because Postgres enums can't drop values without a full type rebuild —
// the app has not written those actions since the tag/party XP rules were
// renamed to tag_ticket/party_complete (see badge.service.ts XP_PER_ACTION).
// Any code writing badgeXpLogTable.action must use one of the 4 values below.
