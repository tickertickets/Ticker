...
export function PosterCardFront({
  ...
  return (
    ...
    >
      {/* Full-card skeleton overlay while backdrop loads — keeps Poster consistent with Classic */}
      {backdropUrl && !imageLoaded && (
        <div
          className="absolute inset-0 animate-pulse z-20"
          style={{ background: POSTER_BG, borderRadius: "inherit" }}
        />
      )}
