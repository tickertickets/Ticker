        ...
        {step === "loading" && (
          <div className="flex flex-col items-center justify-center py-20 gap-4">
            <div className="w-20 h-20 rounded-2xl bg-secondary flex items-center justify-center">
              <Dice5 className="w-10 h-10 text-foreground animate-dice-roll" />
            </div>
            ...
            <div className="flex flex-col" style={{ paddingBottom: "calc(var(--sai-bottom) + 1.5rem)" }}>
              ...
              <div className="px-4">
                <div className="relative rounded-2xl overflow-hidden bg-zinc-900 border border-border" style={{ aspectRatio: "16/9" }}>
                  <PosterImage src={result.posterUrl} alt={result.title} objectPosition="center 20%" eager fallbackIcon={<Film className="w-10 h-10 text-zinc-600" />} />
