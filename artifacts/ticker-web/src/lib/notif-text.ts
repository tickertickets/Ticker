...
export function getNotifText(type: string, lang: Lang, fallback: string): string {
  ...
  switch (type) {
    ...
    case "chain_like":
      return th ? `ถูกใจ Chain ของคุณ` : "liked your Chain";
    case "chain_comment":
      return th ? `คอมเมนต์ Chain ของคุณ` : "commented on your Chain";
    case "comment_reply":
      return th ? "ตอบกลับคอมเมนต์ของคุณ" : "replied to your comment";
    case "chain_comment_reply":
      return th ? "ตอบกลับคอมเมนต์ Chain ของคุณ" : "replied to your Chain comment";
    case "wiki_comment_reply":
      return th ? "ตอบกลับคอมเมนต์ Wiki ของคุณ" : "replied to your Wiki comment";
    default:
