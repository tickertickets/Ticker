...
export default function EditChain() {
  ...
  const goBack = useCallback(() => {
    ...
    if (back) {
      ...
      // Use replace so edit-chain is removed from the nav stack instead of
      // being pushed on top — otherwise the back button in chain-detail would
      // pop back into edit rather than continuing up to profile.
