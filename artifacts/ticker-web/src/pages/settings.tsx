...
import { ChevronLeft, Trash2, RotateCcw, X, Loader2, LogOut, Film, Lock, MessageSquare, Heart, Link2, Moon, Ticket, ChevronRight, Star, Eye, EyeOff, Sparkles, TrendingUp, Users, Bell, Shield } from "lucide-react";
...
export default function Settings() {
  ...
  const initialSection = new URLSearchParams(location.split("?")[1] ?? "").get("section") === "trash" ? "trash" : "main";
  const [activeSection, setActiveSection] = useState<"main" | "trash">(initialSection as "main" | "trash");
      ...
      <div className="sticky top-0 z-30 bg-background border-b border-border">
        <div className="flex items-center gap-3 px-4 pt-5 pb-4">
          ...
          <h1 className="font-display font-bold text-lg text-foreground">
            {activeSection === "trash" ? t.trashPageTitle : t.settingsPageTitle}
          </h1>
        </div>
      </div>
