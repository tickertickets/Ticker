...
function getNotifIcon(type: string) {
  switch (type) {
    ...
    case 'comment': return <MessageCircle className="w-3.5 h-3.5 text-foreground" />;
    case 'comment_reply': return <MessageCircle className="w-3.5 h-3.5 text-foreground" />;
    case 'chain_comment': return <MessageCircle className="w-3.5 h-3.5 text-foreground" />;
    case 'chain_comment_reply': return <MessageCircle className="w-3.5 h-3.5 text-foreground" />;
    case 'wiki_comment_reply': return <MessageCircle className="w-3.5 h-3.5 text-foreground" />;
              ...
              <div
                ...
                onClick={() => {
                  ...
                  if (notif.ticketId && type !== "party_invite" && type !== "memory_request" && type !== "party_color_unlock" && type !== "follow" && type !== "follow_request") {
                    navigate(`/post/ticket/${notif.ticketId}`);
                    ...
                    navigate(`/post/chain/${notifRec["chainId"]}`);
