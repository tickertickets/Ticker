...
export function pushTitleFor(opts: { lang: Lang; type: string; senderName: string }): string {
  ...
  switch (type) {
    ...
    case "chain_like":        return th ? `${name} ถูกใจ Chain ของคุณ` : `${name} liked your Chain`;
    case "chain_comment":       return th ? `${name} คอมเมนต์ Chain ของคุณ` : `${name} commented on your Chain`;
    case "comment_reply":       return th ? `${name} ตอบกลับคอมเมนต์ของคุณ` : `${name} replied to your comment`;
...
export function pushBodyFor(opts: { lang: Lang; type: string }): string | null {
  ...
  switch (opts.type) {
    ...
    case "chain_like":        return th ? "ถูกใจ Chain ของคุณ" : "liked your Chain";
    case "chain_comment":       return th ? "คอมเมนต์ Chain ของคุณ" : "commented on your Chain";
    case "comment_reply":       return th ? "ตอบกลับคอมเมนต์ของคุณ" : "replied to your comment";
