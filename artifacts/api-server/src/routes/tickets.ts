  ...
  asyncHandler(async (req, res) => {
    ...
    await db
      ...
      .set({
        ...
        episodeLabel: typeof episodeLabel === "string" ? (episodeLabel.trim().slice(0, 200) || null) : episodeLabel === null ? null : ticket.episodeLabel,
...
router.post(
  ...
  asyncHandler(async (req, res) => {
    ...
    let extraDetails = details ? sanitize(details) : null;
